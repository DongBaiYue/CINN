...
inline long long int FN_INT64(bitwise_and)(long long int a, long long int b) { return a & b; }
inline long long int FN_INT64(bitwise_or)(long long int a, long long int b) { return a | b; }
inline long long int FN_INT64(bitwise_xor)(long long int a, long long int b) { return a ^ b; }
inline long long int FN_INT64(bitwise_not)(long long int a) { return ~a; }
inline long long int FN_INT64(clz)(long long int a) { return sycl::clz(a); }
inline long long int FN_INT64(popc)(long long int a) { return sycl::popcount(a); }
inline long long int FN_INT64(logical_right_shift)(long long int a, long long int b) { return ((unsigned long long int)a >> b); }
inline long long int FN_INT64(trunc)(long long int a) { return a; }
inline long long int FN_INT64(mod)(long long int a, long long int b) {
  long long int res = a % b;
  if ((res != 0) && ((b ^ res) < 0)) res += b;
  return res;
}

inline long long int FN_INT64(pow)(long long int a, long long int b) {
...
#define EXPAND_REDUCE_INT64_MARCO(MARCO, ...)                          \
  ...
  MARCO(max_int64, std::numeric_limits<int64_t>::min(), long long int, ##__VA_ARGS__) \
  MARCO(min_int64, std::numeric_limits<int64_t>::max(), long long int, ##__VA_ARGS__)

inline long long int cinn_sum_int64(const long long int left, const long long int right) { return left + right; }
inline long long int cinn_prod_int64(const long long int left, const long long int right) { return left * right; }
inline long long int cinn_max_int64(const long long int left, const long long int right) {
  return sycl::max(left, right);
}
inline long long int cinn_min_int64(const long long int left, const long long int right) {
